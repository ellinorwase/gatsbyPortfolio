  ...
  <div>
    ...
    <div className="info-job">
      <p style={{ color: `#116466` }}>
        ...
        have remained a substitute.
      </p>
      <p style={{ color: `#300b3f` }}>
        I worked as an assistant at Astrid Lindgren Children's Hospital, emergency department, in Solna in Stockholm.
        I had responsibility for disinfecting rooms, refilling medicines, etc.
      </p>
      <p style={{ color: `#2C3531` }}>
        For a short period of time I worked at the cinema called SF-bio, south in Stockholm. What I did at SF-Bio was to work at the cash register, replenish goods and customer service.
        and service.
      </p>
      <p style={{ color: `#4f1a1a` }}>
        As the final part of my education at Nackademin, we had an internship of a total of 22
